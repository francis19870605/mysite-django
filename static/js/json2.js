...
<html lang="en" class="">
  <head prefix="og: http://ogp.me/ns# fb: http://ogp.me/ns/fb# object: http://ogp.me/ns/object# article: http://ogp.me/ns/article# profile: http://ogp.me/ns/profile#">
    ...
    <link rel="web-socket" href="wss://live.github.com/_sockets/VjI6MTQ1OTUyMTUxOmZlZmVhNjRiMGUwMjc0ZGNkNjNjZmFjNmMzNzk1NThhMDM1MTFiOTg1MzA5NjEwNWE3YjM3MmY2NzE0MGQwNzA=--5d10ab673742da8067e5026b3295b99aebd4e614">
    <meta name="pjax-timeout" content="1000">
    <link rel="sudo-modal" href="/sessions/sudo_modal">
    <meta name="request-id" content="70146092:654B:14428F98:587B7D74" data-pjax-transient>
...
<meta content="collector.githubapp.com" name="octolytics-host" /><meta content="github" name="octolytics-app-id" /><meta content="70146092:654B:14428F98:587B7D74" name="octolytics-dimension-request_id" /><meta content="3646955" name="octolytics-actor-id" /><meta content="qiwsir" name="octolytics-actor-login" /><meta content="9aa27dcd6483887d3be6bdcc35da9b4381a7a2f4d8f2c67c4f36e6dc8f4a28f1" name="octolytics-actor-hash" />
<meta content="/&lt;user-name&gt;/&lt;repo-name&gt;/blob/show" data-pjax-transient="true" name="analytics-location" />
  ...
  <meta class="js-ga-set" name="dimension1" content="Logged In">
    ...
    <meta name="user-login" content="qiwsir">

        <meta name="expected-hostname" content="github.com">
      <meta name="js-proxy-site-detection-payload" content="M2Q4Y2ZmNzRjYTY3NjYxYzE3MWE0MjBiNDk2Y2YzNzIyODA0NjY5ZjZhYzEzZDU5MzYyOWIxM2M2NmIzMDgzZHx7InJlbW90ZV9hZGRyZXNzIjoiMTEyLjIwLjk2LjE0NiIsInJlcXVlc3RfaWQiOiI3MDE0NjA5Mjo2NTRCOjE0NDI4Rjk4OjU4N0I3RDc0IiwidGltZXN0YW1wIjoxNDg0NDg4MDUzLCJob3N0IjoiZ2l0aHViLmNvbSJ9">


      <link rel="mask-icon" href="https://assets-cdn.github.com/pinned-octocat.svg" color="#000000">
      <link rel="icon" type="image/x-icon" href="https://assets-cdn.github.com/favicon.ico">

    <meta name="html-safe-nonce" content="7368d73ef684b7fb6327fe48a440a18e636b69eb">
...
<ul class="header-nav user-nav float-right" id="user-links">
  <li class="header-nav-item">
    ...
    <a href="/notifications" aria-label="You have unread notifications" class="header-nav-link notification-indicator tooltipped tooltipped-s js-socket-channel js-notification-indicator" data-channel="tenant:1:notification-changed:3646955" data-ga-click="Header, go to notifications, icon:unread" data-hotkey="g n">
...
<a class="dropdown-item" href="https://gist.github.com/" data-ga-click="Header, create new gist">
  ...
  <li class="header-nav-item dropdown js-menu-container">
    <a class="header-nav-link name tooltipped tooltipped-sw js-menu-target" href="/qiwsir"
       aria-label="View profile and more"
       data-ga-click="Header, show menu, icon:avatar">
      <img alt="@qiwsir" class="avatar" height="20" src="https://avatars2.githubusercontent.com/u/3646955?v=3&amp;s=40" width="20" />
      <span class="dropdown-caret"></span>
    </a>
    ...
    <div class="dropdown-menu-content js-menu-content">
      <div class="dropdown-menu dropdown-menu-sw">
        <div class="dropdown-header header-nav-current-user css-truncate">
          Signed in as <strong class="css-truncate-target">qiwsir</strong>
        </div>

        <div class="dropdown-divider"></div>

        <a class="dropdown-item" href="/qiwsir" data-ga-click="Header, go to profile, text:your profile">
          Your profile
        </a>
        <a class="dropdown-item" href="/qiwsir?tab=stars" data-ga-click="Header, go to starred repos, text:your stars">
          Your stars
        </a>
        ...
        <!-- '"` --><!-- </textarea></xmp> --></option></form><form accept-charset="UTF-8" action="/logout" class="logout-form" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="iJaI1CWsJ37CIb9QUKkesGxQZ4z/znYnxg6MsIf8dXoc65nx7SHIMGLO77bMebyg4Dc1UHAj/AAqlNy2ElYtcg==" /></div>
...
<ul class="pagehead-actions">
  ...
  <li>
        <!-- '"` --><!-- </textarea></xmp> --></option></form><form accept-charset="UTF-8" action="/notifications/subscribe" class="js-social-container" data-autosubmit="true" data-remote="true" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="zGJwcJuKIkCTB8R7O3eQ6O0pluTKgpn4oFn7GnjJQKe4sPiWI+/8YGcbQVn7C+ppXlc0XBorV+8Bt20Ub28mfw==" /></div>      <input class="form-control" id="repository_id" name="repository_id" type="hidden" value="1092277" />
  ...
  <li>
    ...
    <!-- '"` --><!-- </textarea></xmp> --></option></form><form accept-charset="UTF-8" action="/douglascrockford/JSON-js/unstar" class="starred" data-remote="true" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="fwW+S5qz8cdXRtiqdcOUxW+2KvfaHTM8UWC3tKPK2vQWrYth1s8WOhk5T9ver77BD8jMa48o6MqOwEyz6hk5PA==" /></div>
      <button
        type="submit"
        ...
        <a class="social-count js-social-count" href="/douglascrockford/JSON-js/stargazers"
           aria-label="6601 users starred this repository">
          6,601
        </a>
</form>
    <!-- '"` --><!-- </textarea></xmp> --></option></form><form accept-charset="UTF-8" action="/douglascrockford/JSON-js/star" class="unstarred" data-remote="true" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="/IbG2GB25/EIaqCdterlP29EF16p7xGTLMCIRAuPVaBdmXmxJhqgZx/QD6u9Or1HpC7mdfwwj0Peypp+vGWItQ==" /></div>
      <button
        type="submit"
        class="btn btn-sm btn-with-count js-toggler-target"
  ...
  <li>
    ...
    <a href="/douglascrockford/JSON-js/network" class="social-count"
       aria-label="3809 users forked this repository">
      3,809
    </a>
  </li>
</ul>
  ...
  <div class="file-actions">
    ...
    <div class="BtnGroup">
      ...
      <a href="/douglascrockford/JSON-js/commits/master/json2.js" class="btn btn-sm BtnGroup-item" rel="nofollow">History</a>
        ...
        <!-- '"` --><!-- </textarea></xmp> --></option></form><form accept-charset="UTF-8" action="/douglascrockford/JSON-js/edit/master/json2.js" class="inline-form js-update-url-with-hash" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="PVvjRsjuIeQNZmSe+TgD9lrPmACyZY1lywe1EQRFtHaPYVcG3dMLWkNxJHm+PCm2mpymJcHVvHCati+Ib98jZQ==" /></div>
          <button class="btn-octicon tooltipped tooltipped-nw" type="submit"
            aria-label="Fork this project and edit the file" data-hotkey="e" data-disable-with>
            <svg aria-hidden="true" class="octicon octicon-pencil" height="16" version="1.1" viewBox="0 0 14 16" width="14"><path fill-rule="evenodd" d="M0 12v3h3l8-8-3-3-8 8zm3 2H1v-2h1v1h1v1zm10.3-9.3L12 6 9 3l1.3-1.3a.996.996 0 0 1 1.41 0l1.59 1.59c.39.39.39 1.02 0 1.41z"/></svg>
          </button>
</form>        <!-- '"` --><!-- </textarea></xmp> --></option></form><form accept-charset="UTF-8" action="/douglascrockford/JSON-js/delete/master/json2.js" class="inline-form" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="43tymJafDqc2jQG9uz3o2ZCidM6uL2C0lNfNzEz+u+iRx1qJwcAoK01+IX0LDYsxyRTMFXBBvkaYAyQ8ozARJw==" /></div>
...
<div id="jump-to-line" style="display:none">
  ...
  <div class="site-footer" role="contentinfo">
    ...
    <ul class="site-footer-links">
      <li>&copy; 2017 <span title="0.11803s from github-fe-54106a2.cp1-iad.github.net">GitHub</span>, Inc.</li>
